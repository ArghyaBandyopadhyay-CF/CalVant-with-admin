...
//   Brain,
//   UserCheck2,
// } from "lucide-react";import UserProfile from "./UserProfile";
...
//     path: "/consent",
//     expandable: false,
//     roles: ["root", "dpo"],   // only root and DPO see this item
//   },
//   // {
//   //   path: "/trust-centre",
//   //   label: "Trust Centre",
...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    quickActions: [
      { label: "   Consent Records", path: "/consent-management/records" },
      { label: "   Audit Trails", path: "/consent-management/audit-trails" },
    ],
    expandable: true,
    roles: ["root", "dpo"], // only root and DPO see this item
  },
