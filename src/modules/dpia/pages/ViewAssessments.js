...
//             <button style={S.backBtn} onClick={() => history.push("/dpia")}>
//               <ArrowLeft size={14} /> Dashboard
//             </button>
//             {!isRiskOwner && (
//               <button
//                 style={S.newBtn}
//                 onClick={() => history.push("/dpia/new")}
//               >
...
//                           onClick={() => history.push(`/dpia/${dpia.id}`)}
//                         >
//                           Open
//                         </button>
//                         <button
...
//                           onClick={() =>
//                             dpia.status === "SUBMITTED" &&
//                             history.push(`/dpia/compliance/${dpia.id}`)
//                           }
//                           title={
//                             dpia.status !== "SUBMITTED"
