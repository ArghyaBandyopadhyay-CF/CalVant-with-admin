...
function BulkRisk() {
  ...
  /* ================= UPLOAD (PRODUCTION LOGIC - DO NOT CHANGE) ================= */
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      // POST to the risk upload endpoint
      await axios.post(
        `${process.env.REACT_APP_SP}/risk-template-service/api/risks/upload`,
        formData,
        {
          headers: {
      ...
      setSnackbar({ 
        open: true, 
        message: 'Bulk risks uploaded successfully ✅', 
        severity: 'success' 
      });
      ...
      >
        <StyledPaper elevation={0}>
          <Box sx={{ mb: 3 }}>
            ...
            >
              Upload and edit multiple risks at once via CSV file
            </Typography>
            ...
            >
              <InfoOutlinedIcon sx={{ fontSize: 20, mt: 0.2 }} />
              <Box>
                <Typography
                  variant="body2"
                  sx={{
                ...
                >
                  Ensure your CSV file contains all required columns for risk data. 
                  You can edit any cell directly in the table below before uploading.
                </Typography>
              </Box>
            </Box>
          </Box>
