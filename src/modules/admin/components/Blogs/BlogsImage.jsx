...
export default function BlogsImage() {
  ...
  const API_BASE = `${process.env.REACT_APP_SP}/blog-service/api/blog-images`; 
  ...
  const handleUploadSubmit = async () => {
    ...
    try {
      ...
      const res = await fetch(API_BASE, {headers: getAdminFetchHeaders({"Content-Type": "application/json"}), 
        method: "POST",
        body: formData, 
      });
